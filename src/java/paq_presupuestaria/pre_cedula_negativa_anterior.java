...
import paq_presupuestaria.ejb.ProgramasAnterior;
 ...
 * @author p-sistemas
 */
public class pre_cedula_negativa_anterior extends Pantalla{
    ...
    private Tabla set_distribu = new Tabla();
     @EJB
    private ProgramasAnterior programas =(ProgramasAnterior) utilitario.instanciarEJB(ProgramasAnterior.class);
    
    public pre_cedula_negativa_anterior() {
