...
public class servicioPlaca {
    private Conexion 
            ...
            con_postgres,//Conexion a la base de postgres 2014
...
public void actualizarDS(Integer id_en,Integer id_s2,String nombre, String cedula, String compro)
    {
        ...
        con_sigag();
        con_sql.ejecutarSql(actualiza1);
        con_sql.desconectar();
        con_sql = null;
    }
...
public void actualizarDE(Integer iden,String ruc,Integer placa)
    {
        ...
        con_sigag();
        con_sql.ejecutarSql(actualiza2);
        con_sql.desconectar();
        con_sql = null;
    }
...
public void eliminarAprobacion(Integer eliminar){
        ...
        con_sigag();
        con_sql.ejecutarSql(aprobacion);
        con_sql.desconectar();
        con_sql = null;
}
