...
public class pre_ingreso_placa extends Pantalla{    
    ...
    public pre_ingreso_placa() {
        ...
        //Configurando el dialogo
        dia_dialogoDP.setId("dia_dialogoDP");
        dia_dialogoDP.setTitle("PLACAS - PLACAS DISPONIBLES"); //titulo
        dia_dialogoDP.setWidth("60%"); //siempre en porcentajes  ancho
        dia_dialogoDP.setHeight("40%");//siempre porcentaje   alto
        dia_dialogoDP.setResizable(false); //para que no se pueda cambiar el tamaño
        dia_dialogoDP.getBot_aceptar().setMetodo("aceptoDialogo");
        
         grid_dp.setColumns(2);
         grid_dp.getChildren().add(new Etiqueta("SELECCIONE Vehiculo"));
         grid_dp.getChildren().add(new Etiqueta("SELECCIONE Servicio"));
        agregarComponente(dia_dialogoDP);
        
        dia_dialogoPL.setId("dia_dialogoPL");
        dia_dialogoPL.setTitle("PLACAS - TOTALES DISPONIBLES"); //titulo
        dia_dialogoPL.setWidth("60%"); //siempre en porcentajes  ancho
        dia_dialogoPL.setHeight("40%");//siempre porcentaje   alto
        dia_dialogoPL.setResizable(false); //para que no se pueda cambiar el tamaño
        dia_dialogoPL.getBot_aceptar().setMetodo("aceptoDialogo");
...
//        tab_placa.setHeader("Placas");
        ...
        pat_panel1.getChildren().add(bot_placa);
