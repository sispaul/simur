...
private Tabla set_tipo = new Tabla();
	...
	pan_opcion.setTransient(true);
        pan_opcion.setHeader("RANGO A INGRESAR");
	efecto.setType("drop");
	efecto.setSpeed(150);
